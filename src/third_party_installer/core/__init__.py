...
class ThirdPartyInstaller:
    ...
    def _load_tools_config(self) -> Dict[str, ThirdPartyTool]:
        ...
        tools['px'] = ThirdPartyTool(
            ...
            description='PX - Corporate proxy authentication tool',
            download_url='https://github.com/genotrance/px/releases/download/v0.8.2/px-v0.8.2-win32.zip',
            executable_paths=[
                'C:\\px\\px.exe',
